...
function makeControlPanel() {
    ...
    if (addFriendsBool === true) {
        njmmDiv.appendChild(friendButton);
    }
    if (removeFriendsBool === true) {
        njmmDiv.appendChild(undoRequestsButton);
    }
    if (unfollowFriendsBool === true) {
        njmmDiv.appendChild(unfollowButton);
    }
    if (unfriendFriendsBool === true) {
        njmmDiv.appendChild(unfriendButton);
    }
    njmmDiv.appendChild(continueButton);
    njmmDiv.appendChild(countInput);
