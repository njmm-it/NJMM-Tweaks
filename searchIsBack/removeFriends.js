/*This allows debugging on android. */
/*At some point I'll probably write up a "developer mode" option that will make this useful.*/
...
announce(`The android "debugger" has loaded.`);
...
document.addEventListener("click",function (e){
 ...
 window.mobileAndTabletcheck = function() {
  ...
  announce(`The mobileandTabletcheck function returns: ` + !check);
  return (!check);
};
...
function redirectURL(location){
    ...
    window.close();//This will close the tab. This is easier than trying to fix the auto-refill-values.
}
...
function dosearch() {
	...
	$('label select:visible, label input:visible').each(function() {
		...
		searchurl = "https://www.facebook.com/search/"+searchquery+"intersect/#njmmTweaksUnfriend";
